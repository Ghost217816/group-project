const games = [
...

  {
    ...
    languages: [
      "Англійська",
      "Українська (частково, фанатський переклад)",
      "Німецька",
      "Французька",
      "інші",
    ],
...

  {
    ...
    editions: [
      ...
      {
        sku: "bundle",
        name: "Snowfall + Cities: Skylines Bundle",
        priceUAH: 449,
        discount: null,
      },
    ],
...

  {
    id: "7",
    title: "Dota 2",
    img: " https://cdn.fastly.steamstatic.com/steam/apps/570/header.jpg",
    ageRating: "16+",
    locale: "uk-UA",
    description:
    ...
    editions: [
      ...
      {
        sku: "battlepass",
        name: "Battle Pass (сезонний)",
        priceUAH: null,
        discount: null,
      },
      {
        sku: "dlc",
        name: "Cosmetics & Bundles",
        priceUAH: null,
        discount: null,
      },
    ],
    ...
    languages: [
      "Англійська",
      "Українська (фанатський переклад)",
      "Російська",
      "Китайська",
      "інші",
    ],
...

  {
    ...
    editions: [
      ...
      {
        sku: "trilogy",
        name: "Legends of the Zone Trilogy",
        priceUAH: 999,
        discount: 33,
      },
    ],
...

  {
    ...
    locale: "uk-UA",
    description:
      "S.T.A.L.K.E.R.: Call of Pripyat — це продовження культової серії, де ви граєте за майора Дегтярьова, який розслідує зникнення військової експедиції в Чорнобильській зоні. Гра поєднує відкритий світ, атмосферу постапокаліпсису та елементи виживання.",
    editions: [
      {
        sku: "standard",
        name: "Standard Edition",
...
function update() {
  ...
  dots.forEach((d) =>
    d.classList.toggle("active", Number(d.dataset.index) === index)
  );
}
